 ...
 public HashMap<Integer, String> fill(String name) {
     ...
     switch(name) {
         ...
         case "Developers":
             ...
             contentMenu.put(2, "по фамилии разработчика вы получите по нему такие данные:\n" +
                     "\t\t- его полное ф.и.о.;\n" +
                     " \t\t- возраст;\n" +
         ...
         case "Projects":
             ...
             break;
         case "Companies":
             contentMenu.put(1, "вывести все компании с указанием:\n" +
                     "\t\t- их рейтинга,\n" +
             ...
             break;
         case "Customers":
             contentMenu.put(1, "вывести всех заказчиков с указанием:\n" +
                     "\t\t- его репутации,\n" +
